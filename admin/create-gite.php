...
$req = $db->prepare('INSERT INTO `cottages` (`id_categ`, `name_gite`,`name_simple_gite`, `location_gite`, `profil_gite`, `desc_gite`, `nbr_sleeping`, `nbr_bathroom`) VALUES (:id_categ, :name_gite, :name_simple_gite, :location_gite, :profil_gite, :desc_gite, :nbr_sleeping, :nbr_bathroom)');
