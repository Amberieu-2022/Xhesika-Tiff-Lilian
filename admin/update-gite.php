...
$req = $db->prepare('UPDATE `cottages` SET `name_gite`= :name_gite, `name_simple_gite` = :name_simple_gite,`location_gite`= :location_gite, `profil_gite` = :profil_gite, `desc_gite`= :desc_gite,`nbr_sleeping`=  :nbr_sleeping,`nbr_bedroom`= :nbr_bedroom,`nbr_bathroom`= :nbr_bathroom WHERE `id_gite` = :id');
